    ...
    return (
        <div id="nav_bar">
            ...
            <div className="nav_elements_container">
                <NavBarElement icon={<HomeIcon />} title="Home" />
                <NavBarElement icon={<SearchIcon />} title="Search" />
                <NavBarElement icon={<NotifcationIcon />} title="Notifications" />
                <NavBarElement icon={<FollowIcon />} title="Follow" />
                <NavBarElement icon={<ChatIcon />} title="Chat" />
                <NavBarElement icon={<GrokIcon />} title="Grok" />
                <NavBarElement icon={<BookmarksIcon />} title ="Bookmarks" />
                <NavBarElement icon={<CommunitiesIcon />} title="Communities" />
                <NavBarElement icon={<PremiumIcon />} title="Premium" />                
                <NavBarElement icon={<ProfileIcon />} title="Profile" />
                <NavBarElement icon={<MoreIcon />} title="More" />
            </div>

            <GeneralButton textColor='black' child={<div>Post</div>} />
        </div>
    )
}
